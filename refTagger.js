...
}(this, function ()
{
	...
	}), o("main", ["config", "root", "passageManager", "tooltips", "referenceRegexes", "cssLoader", "util/classNames", "util/version", "util/settings", "util/dom", "nls/resourceStrings"], function (e, t, o, n, r, s, i, a, l, c, d)
	{
		...
		function u()
		{
			(new Image).src = [H, "://", e.loggerBaseUri, "?", "documentUrl=", encodeURIComponent(M.location), "&referenceCount=", +z.referenceCount, "&microreferenceCount=", +z.markedBibleReferenceCount, "&bibleVersion=", encodeURIComponent(F.bibleVersion), "&usesLibronixLinks=", !!F.addLogosLink, "&usesTooltips=", !!F.useTooltip, "&applicationVersion=", a.version, "&rand=", Math.random().toString().substring(10)].join("")
		}

		function f()
		{
			var e, t, o, n = /lbsRefTaggerPrefs=(?:((?:\w|\d){2,5})\.(true|false))/.exec(M.cookie),
			...
			if (n && (F.bibleVersion = n[1], F.addLogosLink = "true" === n[2]), null !== r)
			{
				...
				F.addLogosLink && (M.getElementById("lbsUseLibronixLinks").checked = "true")
			}
		}
		...
		{
			var s;
			e = h(e), t = o.getVersion(t || F.bibleVersion), s = v(M.createElement("a"), e, t), s.innerHTML = n, r.parentNode.insertBefore(s, r), F.addLogosLink && y(r, e.replace(/(\d)\s*(?:[a-z]|ff)(\W|$)|/g, "$1$2").replace(/\s+/g, "").replace(/[‒–—―]+/g, "-")), z.referenceCount++
		}
		...
		function v(e, t, o)
		{
			...
			{
				O && e.target !== n.openTooltipAnchor && (e.preventDefault(), n.openTooltipAnchor || m.call(this, e))
		...
		function y(e, t)
		{
			var o, n, r = F.logosBibleVersion || F.libronixBibleVersion,
				s = H + "://www.logos.com/images/Corporate/LibronixLink_" + ("light" === (F.libronixLinkIcon || F.logosLinkIcon).toLowerCase() ? "light" : "dark") + ".png",
		...
		{
			var l, d, u, f, p, g, m, b, y, x, L, M = !1,
				N = 0,
				B = F.bibleVersion,
				P = null,
				J = r.abbreviations,
				A = J.length;
			return o && (u = w.exec(e), u && (l = o, d = u[3], b = l + " " + u[2], g = u[1], p = e.substr(u.index + u[0].length))), n && !u && (u = E.exec(e), u && (l = o, d = n, b = i ? l + " " + u[2] : l + " " + d + ":" + u[2], M = I.test(b), g = u[1], p = e.substr(u.index + u[0].length))), !u && S.test(e) && (u = C.exec(e), u && (f = u.length, l = u[3], d = u[4 + A], b = u[2], y = u.indexOf(l, 4) - 4, x = J[y], -1 !== R.indexOf(y) ? (d = 1, M = !1) : M = I.test(b), g = e.substr(0, u.index) + u[1], p = e.substr(u.index + u[0].length), u[f - 1] && (P = u[f - 1], B = P.replace(/\W/g, "")))), u ? (m = u[0].substr((u[1] || "").length), M && !F.tagChapters ? (c.insertTextNode(g + m, t), N = k(p, t, null, null, B === F.bibleVersion ? null : B, !1)) : 155 >= d && (l = l || o, x = x || l, L = x + b.substr(l.length), a ? (B = B || F.bibleVersion, v(a, h(L), B)) : (c.insertTextNode(g, t), T(L, B, null === P ? u[2] : u[2] + P, t), N = k(p, t, l, d, B === F.bibleVersion ? null : B, M), N += F.addLogosLink ? 3 : 2))) : e !== t.nodeValue && (e && s != e && c.insertTextNode(e, t), t.parentNode.removeChild(t)), N
		}
		...
		var S, C, w, E, I, R, M = t.document,
			...
			K = {
				lbsSavePrefs: function ()
				{
					...
					i.setFullYear(i.getFullYear() + 10), M.cookie = "lbsRefTaggerPrefs=" + r + "." + s + ";expires=" + i.toGMTString() + ";path=/", t.location.reload()
				},
				Init: function (t, o)
				{
					var i, a, c, d;
					if (!K.Initialized || o)
					{
						for (F = l.getSettingsOrDefaults(t, e.defaultSettings), M.addEventListener && M.addEventListener("touchstart", function (e)
							{
								O = !0, !V.test(e.target.className) && n.isTooltipOpen() && n.reset()
							}, !1), s.loadCss(B, F), f(), K.noSearchTags = {
								textarea: !0,
								input: !0
							}, c = F.noSearchTagNames.length, i = 0; c > i; i++) d = F.noSearchTagNames[i], K.noSearchTags[d] = !0;
						for (K.noSearchClasses = [], a = F.noSearchClassNames.length, i = 0; a > i; i++) K.noSearchClasses[F.noSearchClassNames[i].toLowerCase()] = !0;
						S = new RegExp(r.referenceQuickTest, "i"), C = new RegExp(r.referenceRegExp, F.caseInsensitive ? "i" : ""), w = new RegExp(r.bookContinuationRegExp), E = new RegExp(r.chapterContinuationRegExp, F.caseInsensitive ? "i" : ""), I = new RegExp(r.chapterReferenceRegExp, "i"), R = r.singleChapterIndexes, K.Initialized = !0
					}
				},
				tag: function (e)
				{
					F.addLogosLink = F.addLogosLink || F.addLibronixDLSLink, K.Initialized || K.Init(), x(e || F.rootNode || N), J || (u(), J = !0)
				}
			};
		return K.init = K.Init, K.regexes = r, t.refTagger && t.refTagger.settings && t.refTagger.settings.tagAutomatically !== !1 && K.tag(), K
	}), t("main")
});